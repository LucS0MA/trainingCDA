...
VALUES 
  ('Hello Worldqq', 'Mon premier post', 'Contenu du post 1',  datetime('now'),  datetime('now'), 1),
  ('Guide SQLqq', 'Un guide simple', 'Voici un guide...',  datetime('now'),  datetime('now'), 2),
  ('Astuces JSqqq', 'Petites astuces en JavaScript', 'Du contenu intéressant...',  datetime('now'),  datetime('now'), 4),
  ('Sécurité Webqq', 'Protéger son appli', 'Utilisez bcrypt et helmet...',  datetime('now'),  datetime('now'), 5);
